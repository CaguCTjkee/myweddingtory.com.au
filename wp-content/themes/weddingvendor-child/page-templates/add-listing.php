...
<?php wp_editor(  $item_description,'add_content');?>                        
                    ...
                    <div class="form-group">
                        <label class="control-label" for="add_google_marker_address"><?php esc_html_e('Google Map Address','weddingvendor');?></label>
                    ...
                    <div id="upload-container">                 
                        <div id="aaiu-upload-container">                 
                            ...
                            esc_html_e('**After Upload image must click on any image to select featured.','weddingvendor');?>
                            </p>
                        </div>  
                    </div>                                                                        
                </div>
